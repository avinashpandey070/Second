...
def home(request):
    ...
    print(random_object)
    return render(request, 'front/hom.html',
...
def about(request):
    ...
    return render(request, 'front/about.html',{'site':site,'news':news,'cat':cat,'subcat':subcat,
                   'lastnews':lastnews,'popnews2':popnews2,'trending':trending})
def panel(request):
    # login check start
...
def contact(request):
    ...
    popnews2 = News.objects.all().order_by('-show')[:3]
    trending = Trending.objects.all().order_by('-pk')[ :5]
    return render(request,'back/contact.html',{'site':site,'news':news,'cat':cat,'subcat':subcat,
                   'lastnews':lastnews,'popnews2':popnews2,'trending':trending})
    ...
    if request.method == 'POST':
        ...
        if user != None:
            ...
            if count1 == 1 and count2 == 1 and count3 == 1 and count4 == 1 :
                ...
                error = 'Your New password should contain atleast 1 letter in upper n lowercase,1 number,1 special character'
                return render(request, 'back/error.html', {'error': error})
        else:
...
def myregister(request):
    if request.method == 'POST':
        ...
        if password1 != password2 :
            msg = 'password & confirm password didnot match'
            return render(request, 'front/msgbox.html', {'msg': msg})
        count1 = 0
        count2 = 0
        count3 = 0
        ...
        if count1 == 0 and count2 == 0 and count3 == 0 and count4 == 0:
            msg = 'Your New password should contain atleast 1 letter in upper n lowercase,1 number,1 special character'
            return render(request, 'front/msgbox.html', {'msg': msg})
        if len(password1) < 8 :
            msg = 'Your password must be atleast 8 character'
            return render(request, 'front/msgbox.html', {'msg': msg})
